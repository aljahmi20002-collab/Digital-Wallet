        ...
        return [
            ...
            [
                ...
                'content_data'   => [
                    ...
                    'description'           => ['en' => 'DigitalWallet is a private, fully-licensed digital wallet engineered for those who measure wealth in decades, not quarters. Hold, grow and move capital across borders with the composure of a century-old bank — rendered weightless.'],
            ...
            [
                ...
                'content_data'   => [
                    'eyebrow'        => ['en' => 'About DigitalWallet'],
                    'heading'        => ['en' => 'The Standard of __Digital Wealth.__'],
                    'description'    => ['en' => "We are custodians, not merely a platform. Every facet of DigitalWallet — from cold-storage architecture to the calligraphy of a statement — is shaped by a single conviction: that tomorrow's fortunes deserve the patience and precision of the great houses of finance."],
            ...
            [
                ...
                'repeated_content' => [
                    ...
                    ['service_icon_class' => 'fa-solid fa-credit-card',    'service_title' => ['en' => 'Private Card'],          'service_text' => ['en' => 'The DigitalWallet Black — a metal card in seven finishes, accepted in 211 countries.'],                    'service_link' => '#'],
            ...
            [
                ...
                'repeated_content' => [
                    [
                        ...
                        'rating'          => '5',
                        'comment_text'    => ['en' => 'DigitalWallet carries the patience of a private bank and the precision of a Swiss movement. Three years in, I have yet to encounter a single click that felt rushed.'],
                    ],
                    [
                    ...
                    [
                        ...
                        'rating'          => '5',
                        'comment_text'    => ['en' => 'We tested four custodians for our succession trust. DigitalWallet was the only one whose statement of holdings I would frame. The yield was simply the dividend on that taste.'],
                    ],
                ],
            ],
